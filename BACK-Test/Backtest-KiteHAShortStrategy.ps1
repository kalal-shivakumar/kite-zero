<#
.SYNOPSIS
  Backtest Heikin-Ashi Short-only strategy using historical candle data.
.DESCRIPTION
  Fetches historical OHLCV data from Kite Connect API, converts to Heikin-Ashi
  candles, and simulates the Short strategy (same logic as Invoke-KiteHAShortStrategy).
  
  Entry: HA Close < Previous HA Low  (Short Entry)
  Exit:  HA Close > Previous HA High (Short Exit)
...
.EXAMPLE
  .\Backtest-KiteHAShortStrategy.ps1 -TradingSymbol NIFTY -StartDate 0 -EndDate -1
  .\Backtest-KiteHAShortStrategy.ps1 -TradingSymbol NATGASMINI -StartDate -7 -EndDate 0
  .\Backtest-KiteHAShortStrategy.ps1 -TradingSymbol BANKNIFTY -StartDate "2026-04-20" -EndDate "2026-04-25"
#>
...
Write-Host "  BACKTEST: HA Short Strategy" -ForegroundColor Cyan
Write-Host "  ====================================================" -ForegroundColor Cyan
...
# ================================================================
Write-Host "  ====================================================" -ForegroundColor Cyan
Write-Host "  BACKTEST REPORT: HA Short Strategy" -ForegroundColor Cyan
Write-Host "  ====================================================" -ForegroundColor Cyan
Write-Host "  Symbol    : $sym ($label)" -ForegroundColor White
Write-Host "  TimeFrame : $TimeFrame" -ForegroundColor White
Write-Host "  Period    : $fromDate to $toDate" -ForegroundColor White
