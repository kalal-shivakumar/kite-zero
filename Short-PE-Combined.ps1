...
if (Test-Path $PositionFile) {
    ...
    Write-Host "  Restored position: $($script:PE_EntrySymbol) | Strike: $($script:PE_EntryStrike) | Qty: $($script:PE_EntryQty) | Entry LTP: $($script:PE_EntryOptionLTP)" -ForegroundColor Yellow
}
